  ...
  return (
    <div className="sidebar">
      ...
      <div className="flex h-full w-full flex-col place-content-center gap-7">
        ...
        <div className='flex flex-row items-center gap-5 w-full text-sm font-light'>
        Customer:
        ...
        <button className="primary-button" name="dinein" onClick={handleChange}>Dine In</button>
        <button className="primary-button" name="takeaway" onClick={handleChange}>Takeaway</button>
      </div>
    </div>
  )
}
